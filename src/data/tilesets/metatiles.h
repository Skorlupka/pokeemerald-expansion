...
const u16 gMetatiles_1Shycove[] = INCBIN_U16("data/tilesets/secondary/1shycove/metatiles.bin");
const u16 gMetatileAttributes_1Shycove[] = INCBIN_U16("data/tilesets/secondary/1shycove/metatile_attributes.bin");
